...
## 图片
- 约 177 张 fig_*.png（pyvips 压缩约 3.7MB）
- EN/ZH 注入图引用
...
### 残留
- **修正：** `fig_20_2.png` 一度被错绑为 Fig 20.1 的双图（550×302）；已从 PDF p392 嵌入图恢复为 2×2 多格图（438×803），与正文「右下图 K 线 18–22」一致。单测 `test_fig_20_2_is_multipanel_not_fig_20_1` 锁定尺寸与非 20.1 副本。
