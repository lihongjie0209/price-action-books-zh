...
r The day has a strong trend in the ﬁrst hour or so and then enters a trading
range.
r The trading range lasts for hours and often lulls traders into thinking that the
day will be quiet into the close.
r The trend resumes in the ﬁnal hour or two.
r The second leg often is about the same size as the ﬁrst leg.
...
or on the breakout.
Sometimes there will be a strong trend for the ﬁrst hour or so and then the market goes sideways for several hours. Whenever this happens and especially if the
...
might be a strong trend in the ﬁnal hour or so. The breakout is usually in the direction of the earlier trend, but sometimes it can be in the opposite direction and
...
succeeds and the trend in the ﬁnal hour, if there is one, can retrace all or part of the
opening bear trend.
...
lazy pushes, creating a wedge ﬂag. At other times the third leg fails to surpass the
second, and this forms a head and shoulders ﬂag (most head and shoulders reversal patterns fail and become continuation patterns). Because the pattern often has
...
out of their losing longs, adding to the collapse into the close. The difﬁcult part of
...
of the open to resume in the ﬁnal hour, and be prepared to enter. For example,
...
was the ﬁrst moving average gap bar of the day.
...
and therefore the ﬁrst push down, the next bar had a bull body and therefore traded up,
...
trend resumption into the close with the ﬁnal sell-off often being as large as the
initial one. There is frequently a failed breakout of the top of the range before the
ﬁnal bear leg begins. Bar 12 was a perfect setup for a swing short because it was a
...
on the height from the open or low of the ﬁrst bar of the spike to the close or high of
the ﬁnal bar. The closing high of the day was at a measured move from the open of bar
...
though the middle of the day was setting up perfectly for a big sell-oﬀinto the close,
...
support line at the bar 7 low to the tick and continued to ﬁnd buyers. There were double
...
bar 2 low to be followed by a double bottom bull ﬂag, but, in the absence of strong
...
from bar 5 to bar 14, ﬁve days after the ﬁrst move down.
