...
a good chance of resulting in a proﬁtable trade. In practice, every bar on the
...
a trade is entered. As soon as your entry order is ﬁlled, the prior bar becomes a
...
have enough follow-through for them to make at least a scalper’s proﬁt. However,
...
side of your trade, or else your order will not get ﬁlled). As traders, our edge is our
...
orders that never get ﬁlled. It is usually best to enter on a stop at one tick above
...
look more like tadpoles or small ﬁsh, a tail is a more accurate descriptive term.
...
like a bull reversal bar just after breaking out of a ﬁnal bear ﬂag. Then, with ﬁve to
...
high is near the high of the bear ﬂag. You have seconds to decide if you still want to
buy above its high with the realization that you would be buying at the top of a bear
ﬂag. Until you are consistently proﬁtable and able to read quickly, it is best to not
take the trade and to wait for a second entry instead. However, if you are conﬁdent
that there are lots of trapped bears, then you can take the trade, but the risk is
signiﬁcant whenever there are several large range bars in a row with lots of overlap.
...
climax ends with the ﬁrst pause bar. For example, if there are three consecutive
...
patterns will be discussed later in the book. The ﬁrst leg was completed by the iii
...
above this bar would have been ﬁlled and then bar 3 became a signal bar (instead of
