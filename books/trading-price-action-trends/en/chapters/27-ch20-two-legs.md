...
extends deeper than the ﬁrst. Trends themselves also tend to subdivide into two
smaller legs as well. Elliott Wave followers look at a trend move and see three
with-trend waves. However, it is better to look at the ﬁrst strong with-trend leg
...
major reversal, or any time that enough traders believe that the move has sufﬁcient
...
take proﬁts above the ﬁrst leg, new bears will short, and other bears who shorted
the ﬁrst up leg will add to their shorts as soon as the second leg up goes above the
high of the ﬁrst leg. If all of these shorts overwhelm the traders who bought the
breakout above the ﬁrst leg up, the market will go down and enter either a trading
...
charts for the one signal a day that they might provide simply is not a sound ﬁnancial decision.
...
or pullback is likely. But when the ﬁrst move is not clearly the possible end of a
...
This is difﬁcult and frustrating for traders who want perfect patterns; but when
you trade, you are always in a gray fog and nothing is perfectly clear. However,
whenever you are not conﬁdent about your read, do not take the trade—there will
