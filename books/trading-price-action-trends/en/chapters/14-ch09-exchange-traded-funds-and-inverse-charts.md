...
you are seeing a bull ﬂag but something doesn’t seem quite right, consider looking
...
that the bull ﬂag that you were seeing on the Emini and SPY might now look like a
rounding bottom on the SDS. If it does, you would be wise not to buy the Emini ﬂag
...
Since an ETF is a fund, the ﬁrm that runs it is doing so to make money and
